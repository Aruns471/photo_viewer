...
connect_str = 'DefaultEndpointsProtocol=https;AccountName=cloudcomputingtesting;AccountKey=jtgE5aCz+0K/HTbzgu1kE1X7KFRvlVv9RzjTAWRc3FgzKq3gslbj5XPde3dDYgaedIcWqsZdjFes+AStK+BocQ==;EndpointSuffix=core.windows.net' # retrieve the connection string from the environment variable
